...
mygui.prompt("Type \"boxedRadioColumnTest()\" to start... ")

userClick = False
result = ""

def boxedRadioColumnTest():
    dcl_id = mydcl.loadDialog("test/boxed_radio_column_test.dcl")
    
    if mydcl.newDialog("boxed_radio_column_test", dcl_id) == False:
        print("[boxedRadioColumnTest] Error: can not load gui!")
        return
    ...
    if userClick:
         ...
         print("[boxedRadioColumnTest] Cancel pressed")
