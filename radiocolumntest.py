...
mygui.prompt("Type \"radioColumnTest()\" to start... ")

userClick = False
result = ""

def radioColumnTest():
    dcl_id = mydcl.loadDialog("test/radio_column_test.dcl")
    
    if mydcl.newDialog("radio_column_test", dcl_id) == False:
        print("[radioColumnTest] Error: can not load gui!")
        return
    ...
    if userClick:
         ...
         print("[radioColumnTest] Cancel pressed")
