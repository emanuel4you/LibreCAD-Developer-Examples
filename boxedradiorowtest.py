...
mygui.prompt("Type \"boxedRadioRowTest()\" to start... ")

userClick = False
result = ""

def boxedRadioRowTest():
    dcl_id = mydcl.loadDialog("test/boxed_radio_row_test.dcl")
    
    if mydcl.newDialog("boxed_radio_row_test", dcl_id) == False:
        print("[boxedRadioRowTest] Error: can not load gui!")
        return
    ...
    if userClick:
         ...
         print("[boxedRadioRowTest] Cancel pressed")
